      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <Pressable
            style={({ pressed }) => [
              styles.filterButton,
              {
                backgroundColor: isFilterActive ? theme.primary : theme.primaryMuted,
              },
        ...
        {isFilterActive && (
          <View style={styles.filterChipsRow}>
            <View style={[styles.filterChip, { backgroundColor: theme.primaryMuted, borderColor: theme.border, borderWidth: 1 }]}>
              <MaterialIcons name="event" size={14} color={theme.primary} />
              <ThemedText type="small" style={[styles.filterChipText, { color: theme.primary }]}>
                {formatDateShort(dateFilter.startDate)} -{' '}
                {formatDateShort(dateFilter.endDate)}
              </ThemedText>
              <Pressable onPress={resetFilters} hitSlop={8}>
                <MaterialIcons name="cancel" size={16} color={theme.primary} />
              </Pressable>
            </View>
          </View>
        )}
            ...
            !isLoading ? (
              <View style={styles.emptyContainer}>
                <View style={[styles.emptyIconCircle, { backgroundColor: theme.backgroundSelected }]}>
                  <MaterialIcons
                    name={searchQuery || isFilterActive ? 'search-off' : 'post-add'}
                    size={40}
                ...
                {searchQuery || isFilterActive ? (
                  ...
                  >
                    <ThemedText style={styles.emptyActionBtnText}>
                      Filtreleri Temizle
                    </ThemedText>
                  </Pressable>
                ) : (
